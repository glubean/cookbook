 ...
 *
 *   Draft (mocked, offline, no key):  GLUBEAN_MOCK=1 npx glubean run explore/mocking
 *   Real  (live sandbox, needs key):  npx glubean run explore/mocking
 *
 * Read explore/mocking/README.md before leaning on this. It is a scaffold,
